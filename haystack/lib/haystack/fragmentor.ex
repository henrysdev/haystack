defmodule Haystack.Fragmentor do
  @moduledoc """
  The Haystack.Fragmentor module is responsible for orchestrating the fragmenting 
  ...
  def fragment(in_fpath, count, password, out_dpath, save_orig) when count > 1 do
    ...
    frag_size = chunk_size + Haystack.Fragmentor.Fields.get_bytes_count()
  ...
  defp finish_frag({ seq_id, read_pos }, file_info_pid) do
    ...
    # Fields
    file_name_field = Haystack.Fragmentor.Fields.file_name(file_name, hashkey)
    pl_length_field = Haystack.Fragmentor.Fields.pl_length(file_size, chunk_size, hashkey, read_pos)
    file_size_field = Haystack.Fragmentor.Fields.file_size(file_size, hashkey)

    # Payload
    encr_pl = Haystack.Fragmentor.Payload.extract(in_fpath, read_pos, hashkey, chunk_size, file_size)
    ...
    # HMAC
    hmac = Haystack.Fragmentor.HMAC.generate(frag_file, chunk_size, file_name_field, file_size_field, pl_length_field, seq_id, hashkey)
